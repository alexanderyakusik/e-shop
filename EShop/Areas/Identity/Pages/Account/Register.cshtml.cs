...
namespace EShop.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            RolesSelectList = GetRolesSelectList();
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (HttpContext.User.IsSuperUser())
                    {
                        if (await AddUserRole(user, Input.Role))
                        {
                    ...
                    if (!await AddUserRole(user, Role.User))
                    {
                        return Page();
                    }
        ...
        private async Task<bool> AddUserRole(IdentityUser user, string role)
        {
        ...
        private void SetModelErrors(IdentityResult result)
        {
